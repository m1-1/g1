...
def generate(title, author, date, domain, config="lm/configs/mega.json", checkpoint="models/mega/model.ckpt"):
    params = {
        ...
        "title": f"{title}",
        "text": "",
        "summary": "We’ve got budget, retirement account, credit, information security and insurance advice for your independent adult, college student, gap-year taker or future soldier.",
        "authors": [f"{author}"],
        "publish_date": f"{date}",
        "domain": f"{domain}",
        "warc_date": "",
