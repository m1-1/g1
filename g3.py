...
def generate(title, author, date, domain, config="lm/configs/mega.json", checkpoint="models/mega/model.ckpt"):
    params = {
        ...
        "url_used": "",
        "title": f"{title}",
        "text": "We’ve got budget, retirement account, credit, information security and insurance advice for your independent adult, college student, gap-year taker or future soldier.TL;DR",
        "summary": "",
        "authors": [f"{author}"],
        "publish_date": f"{date}",
        "domain": f"{domain}",
